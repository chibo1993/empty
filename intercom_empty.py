...
class Intercom_empty(Intercom_DFC):
    ...
    def send(self, indata):
        ...
        if self.NOBPTS > self.max_NOBPTS:
            ...
            #Aquí utilizamos un auxiliar para llevar la cuenta, donde  lo inicializamos con el valor de
            #self.played_chunk_number%self.cells_in_buffer que es igual a 0.
